...
date_txt_from = "2011-10-03"
date_txt_to_base = "2014-05-16"

nbre_step_backward <- 0
nbre_generation <- 100
...
tryParams <- function (m, omega, tc) {  
  lm.result <- LPPL(rTicker, m, omega, tc)
  plot(rTicker$t, rTicker$Close, typ='l', xlab="Date", ylab="Price", main=fileSName) #base graph based on data
